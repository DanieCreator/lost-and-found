...
<footer class="footer">
			...
			<div class="row">
				...
				<div class="col-lg-3 footer_col">
					...
					<div class="footer_about">
						<p><?= SITE_NAME ?> is your ultimate site for finding lost loved ones and reporting any case of a strange people within your locality at just a click of a button.</p>
					</div>
				</div>
				...
				<div class="col-lg-3 footer_col">
					...
					<ul class="footer_useful_links">
						...
						<li class="useful_links_item"><a href="contacts.html">Contacts</a></li>
						<li class="useful_links_item"><a href="about.htnl">About</a></li>
				...
				<div class="col-lg-3 footer_col">
					...
					<ul class="contact_info_list">
						...
						<li class="contact_info_item d-flex flex-row">
							...
							<div class="contact_info_text">+254 799 784 614</div>
						</li>
						<li class="contact_info_item d-flex flex-row">
						...
						<li class="contact_info_item d-flex flex-row">
							...
							<div class="contact_info_text"><a href="#">www.thehomefinder.com</a></div>
						</li>
					</ul>
				</div>
	...
	<div class="credits">
		<span class="text-center">
			...
			All rights reserved by Lost & Found
			</small>
		</span>
	</div>
