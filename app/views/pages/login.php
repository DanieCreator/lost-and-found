		...
		<div class="container">
			<div class="row agents_row">
				<div class="col-md-6 offset-md-3">
					...
					<h3 class="intro_title font-weight-bold">Sign In to your Account</h3>
			...
			<div class="row">
				<div class="col-lg-12 text-center">
					<div class="agents_more">
						<div class="button agents_more_button trans_200"><a class="trans_200" href="/login">Don't have an account yet? Create One</a></div>
					</div>
				</div>
			</div>
		</div>
